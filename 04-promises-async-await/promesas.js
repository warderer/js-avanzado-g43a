...
// 1. Crear una promesa que simule ordenar una pizza
function ordenarPizza(sabor) {
    ...
    return new Promise((resolve, reject) => {
        ...
        //3. Simular un tiempo de espera de preparación de la pizza (para hacerlo asícrono)
        setTimeout(() => {
...
// Caso 1. Order una pizza que si tenemos en el menú: pepperoni
...
// Caso 2. Order una pizza que NO tenemos en el menú: suprema
